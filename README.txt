  ...
  For installation instructions, please see the Simplify iOS installation instructions:
  ...
  This is version 2.1.0 of the SDK.  See CHANGES.txt for a list of updates to the SDK.
